"""
Loki connector tests focused on validating that query normalization correctly handles empty and empty-compatible matchers, ensuring that queries are transformed into a format that Loki can process without errors.
