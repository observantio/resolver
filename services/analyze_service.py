...
def get_provider(tenant_id: str) -> DataSourceProvider:
    # Local import avoids circular deps: api.routes → analyze → analyze_service → api.routes.common
    from api.routes.common import get_provider as route_get_provider  # pylint: disable=import-outside-toplevel
